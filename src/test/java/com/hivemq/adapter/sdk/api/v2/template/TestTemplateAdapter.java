 ...
 * {@link AbstractProtocolAdapter} alone — only the abstract {@code do*} methods, synthetic values built with
 * the reused v1 {@code DataPointFactory}. Test-scope only; never shipped, never registered.
 */
final class TestTemplateAdapter extends AbstractProtocolAdapter {
