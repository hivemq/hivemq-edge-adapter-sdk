 ...
 * <p>
 * {@link com.hivemq.adapter.sdk.api.v2.node.Node} is the protocol-specific half: a passive data object,
 * subclassed per protocol, and the ONLY thing a protocol adapter ever sees.
 * {@link com.hivemq.adapter.sdk.api.v2.node.Tag} is Edge's half. The two are created together via
 * {@link com.hivemq.adapter.sdk.api.v2.node.NodeTagPair} and each holds a direct reference to the other —
