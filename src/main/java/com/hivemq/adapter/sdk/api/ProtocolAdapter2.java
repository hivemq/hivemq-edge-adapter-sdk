 ...
 * <p>
 * Key differences from {@link ProtocolAdapter}:
 * <ol>
 ...
 *   <li>Connection state is managed by the caller (the wrapper), not by the adapter itself</li>
 *   <li>Adapter should NOT manage its own state</li>
 * </ol>
 * <p>
 * Each adapter module provides its own implementation of this interface, typically by extending
 * {@link ProtocolAdapter2Bridge} and overriding {@link #supportsSouthbound()}.
 */
