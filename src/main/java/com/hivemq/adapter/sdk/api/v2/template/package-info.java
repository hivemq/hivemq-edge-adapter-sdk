 ...
 * dependency.
 * <p>
 * {@link com.hivemq.adapter.sdk.api.v2.template.AbstractProtocolAdapter} turns the asynchronous
 * {@link com.hivemq.adapter.sdk.api.v2.ProtocolAdapter} command interface into single-threaded {@code do*}
 * methods: each command method {@code tell}s one immutable
 * {@link com.hivemq.adapter.sdk.api.v2.messaging.command.ProtocolAdapterCommand} onto the adapter's own
 * {@link com.hivemq.adapter.sdk.api.v2.messaging.DefaultMailbox}, and the
 * {@link com.hivemq.adapter.sdk.api.v2.messaging.MessageDispatcher} supplied by the framework feeds them to
