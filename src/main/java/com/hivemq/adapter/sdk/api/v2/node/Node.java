 ...
 * protocol. The protocol adapter sees {@code Node} ONLY: it never sees {@link Tag}, mappings, or anything on
 ...
 * against {@link com.hivemq.adapter.sdk.api.v2.ProtocolAdapterInformation#nodeClass()}. Only fields are
 ...
 * ({@link com.hivemq.adapter.sdk.api.v2.model.BrowseFilter} for "browse from the root").
 */
