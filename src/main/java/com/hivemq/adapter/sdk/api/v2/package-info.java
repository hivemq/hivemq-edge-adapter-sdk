 ...
 * <p>
 * <b>Mechanism vs. policy.</b> A {@link com.hivemq.adapter.sdk.api.v2.ProtocolAdapter} is <b>pure
 * mechanism</b>: it executes commands and reports state and events through its
 * {@link com.hivemq.adapter.sdk.api.v2.model.ProtocolAdapterOutput}. It has ZERO retry, backoff, reconnect, or
 ...
 * queue (see {@link com.hivemq.adapter.sdk.api.v2.messaging}). Delivery is by message-type priority
 ...
 * <p>
 * <b>Naming rules.</b> N1: the {@code api.v2} package name carries the version — a v2 type mirrors its v1
 * counterpart's name with no suffix (distinguished by package, not by a {@code 2}), and no identifier carries
 * a {@code 2}. N2: no abbreviations in any API name, method signature, or variable name.
 */
